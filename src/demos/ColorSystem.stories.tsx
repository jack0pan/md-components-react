...
export const Primary = () => (
  <>
    ...
    <span className="color-system-block bg-primary-container text-on-primary-container">
      Primary Container
    </span>
    <span className="color-system-block bg-on-primary-container text-primary-container">
...
export const Secondary = () => (
  <>
    ...
    <span className="color-system-block bg-secondary-container text-on-secondary-container">
      Secondary Container
    </span>
...
export const Tertiary = () => (
  <>
    ...
    <span className="color-system-block bg-tertiary-container text-on-tertiary-container">
      Tertiary Container
    </span>
    <span className="color-system-block bg-on-tertiary-container text-tertiary-container">
...
export const Error = () => (
  <>
    ...
    <span className="color-system-block bg-error-container text-on-error-container">
      Error Container
    </span>
    <span className="color-system-block bg-on-error-container text-error-container">
      On Error Container
    </span>
  </>
);
...
export const NeturalVariant = () => (
  <>
    <span className="color-system-block bg-surface-variant text-on-surface-variant">
      Surface Variant
    </span>
    <span className="color-system-block bg-on-surface-variant text-surface-variant">
      On Surface Variant
    </span>
